...
WALL_COLOR = formatColor(255.0/255.0,99.0/255.0,71.0/255)
INFO_PANE_COLOR = formatColor(.4,.4,0)
SCORE_COLOR = formatColor(.9, .9, .9)
PACMAN_OUTLINE_WIDTH = 1
...
PACMAN_COLOR = formatColor(151.0/255.0, 255.0/255.0, 255.0/255.0)
PACMAN_SCALE = 0.4
#pacman_speed = 0.25

# Food
FOOD_COLOR = formatColor(220.0/255.0,255.0/255.0,61.0/255)
FOOD_SIZE = 0.3
...
class InfoPane:
    ...
    def updateScore(self, score):
        changeText(self.scoreText, " B.M El Khalil || SCORE: % 4d" % score)
